...
public class Equipo {
    ...
    public static Equipo crearEquipo(final Jugador representante, final Double edadPromedio, final List<String> jugadoresEquipo) {
        val equipo = new Equipo();
        equipo.setRepresentante(representante);
        equipo.setEdadPromedio(edadPromedio);
        equipo.setJugadoresEquipo(jugadoresEquipo);
        return equipo;
    }
